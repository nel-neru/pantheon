...
| `ImprovementExecutorAgent` | 承認済み提案をコードへ反映し、PR/ローカルブランチを作成 | `PROMPT_ENGINEERING`, `TOOL_INTEGRATION` | `repocorp approve`, `SelfImprovementLoop` | GitHub token がなければローカル適用 |
