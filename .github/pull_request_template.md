...
- [ ] Backend tests pass at baseline: `\.venv\Scripts\python.exe -m pytest tests\ -q` → **0 known failures on Windows** (the 2 chmod 0o600 tests skip there and pass on Linux CI); any failure is a regression.
